...
//2. Using LinkedHashSet (maintains the insertion order ) [Takes more memory]
class Solution {
    public int removeDuplicates(int[] nums) {
...
//3. COUNTING SORT (effective when array has negative values) also constraint is within range  [Takes more memory]
...
//Less Memory more optimised approach
class Solution {
    public int removeDuplicates(int[] nums) {
